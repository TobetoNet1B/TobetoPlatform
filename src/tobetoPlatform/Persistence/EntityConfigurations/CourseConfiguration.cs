...
public class CourseConfiguration : IEntityTypeConfiguration<Course>
{
    public void Configure(EntityTypeBuilder<Course> builder)
    {
        ...
        builder.Property(c => c.ImgUrl).HasColumnName("ImgUrl");
        builder.Property(c => c.SoftwareLanguage).HasColumnName("SoftwareLanguage");
        ...
        builder.Property(c => c.TimeSpent).HasColumnName("TimeSpent");
